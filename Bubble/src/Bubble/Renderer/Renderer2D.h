...
namespace Bubble {
	...
	public:
		...
		static void DrawCircle(const glm::vec3 pos, const float r, const glm::vec4 color);
		static void DrawCircleFilled(const glm::vec3 pos, const float r, const glm::vec4 color);
		static void DrawCircleFilled(const glm::mat4& transform, const glm::vec4& color, float thickness = 1.0f, float fade = 0.005f, int entityID = -1);
