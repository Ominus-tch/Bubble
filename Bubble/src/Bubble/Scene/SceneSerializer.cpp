...
namespace YAML {
	...
	template<>
	struct convert<Bubble::UUID>
	{
		static Node encode(const Bubble::UUID& uuid)
		{
			Node node;
		...
		static bool decode(const Node& node, Bubble::UUID& uuid)
		{
...
#define READ_SCRIPT_FIELD(FieldType, Type)             \
	...
	static void SerializeEntity(YAML::Emitter& out, Entity entity)
	{
		...
		if (entity.HasComponent<MeshComponent>())
		{
			...
			out << YAML::Key << "ModelPath" << YAML::Value << meshComponent.Path;
